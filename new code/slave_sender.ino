...
void loop() {
  current1 = getVPP(sensor1)*10;
  current2 = getVPP(sensor2)*10;
  current3 = getVPP(sensor3)*10;
  current4 = getVPP(sensor4)*10;
...
void requestEvent() {
  ...
  Serial.print("Current 1 is :"); 
  Serial.println(current1);
    Serial.print("Current 2 is :"); 
  Serial.println(current2);
    Serial.print("Current 3 is :"); 
  Serial.println(current3);
    Serial.print("Current 4 is :"); 
